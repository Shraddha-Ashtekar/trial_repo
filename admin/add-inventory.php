...
$query="insert into messdetails(product_name,supplier_name,quantity,order_date,cost) values(?,?,?,?,?)";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('ssiii',$pname,$supname,$quantity,$odate,$cost);
$stmt->execute();
echo"<script>alert('Inventory has been added successfully');</script>";
}
?>
