...
$rc=$stmt->bind_param('sssssisi',$fname,$mname,$lname,$gender,$contactno,$udate,$aid);
$stmt->execute();
}
 ...
 while($row=$res->fetch_object())
{
  ?>
			...
			<tr>
      <td colspan="2"  ><?php echo ucfirst($row['firstName']);?> <?php echo ucfirst($row['lastName']);?>'S <span> information &raquo;</span> </td>
  </tr>
			<tr>
...
<tr>
<td width="12%" valign="top" class="heading">Sap ID: </td>
<td class="comb-value1"><?php echo $row['sapid'];?></td>
</tr>
