...
$query="update  registration set firstName=?,lastName=?,corresAddress=?,contactno=?,emailid=?,updationDate=? where id=?";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('sssssisi',$fname,$lname,$address,$contactno,$email,$udate,$aid);
$stmt->execute();
...
<div class="col-sm-8">
<input type="text" name="address" id="address"  class="form-control"  value="<?php echo $row->corresAddress;?>" required="required">
</div>
</div>
